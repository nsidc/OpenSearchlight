...
(function(factory) {
   if (typeof module === 'object' && typeof module.exports === 'object') {
      ...
      if (typeof window.$ === 'undefined' || typeof window._ === 'undefined')
         throw 'jQuery and underscore must be loaded first';
  ...
  OpenSearchlight.openSearchQuery = function () {
    this.initialize.apply(this, arguments);
  };

  // Instance methods
  _.extend(OpenSearchlight.openSearchQuery.prototype, {
  ...
  // *Instance methods*
  _.extend(OpenSearchlight.openSearchDescriptionDocument.prototype, {
    ...
    getQueryUrl: function (params, contentType) {
      ...
      return queryUrl.replace('http:', 'https:');
    }
  ...
  // necessary.
  _.extend(OpenSearchlight.openSearchDescriptionDocument, {
    //
    ...
    validate: function (osddXml) {
      ...
      if(!osddXml.match(/http:\/\/a9.com\/-\/spec\/opensearch\/1.1\//)) {
        return false;
      }
      return true;
    },
