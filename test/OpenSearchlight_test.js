...
describe("the query facade", function () {
   ...
   it("should use the OSDD success function generator and pass that to the opensearch service", function () {
      var generatorFn, generatedFn, queryParams = {osdd: ""};
...
test("An error should be thrown if a success callback is not provided", function () {
   // TODO
...
test("An error should be thrown if an OSDD is not provided", function () {
   // TODO
...
test("The error callback should not be called normally", function () {
...
test("sad path: the error callback is called if the OSDD returns a 404", function () {
   // TODO
   equal(true, true);
});
